...
import edu.neu.ecommerce.statistics.flink.sink.SinkMysql;
...
@Component("clickFlinkJob")
@Slf4j
public class ClickFlinkJob implements FlinkJob{

    private final SinkMysql sinkMysql;

    public ClickFlinkJob(SinkMysql sinkMysql) {
